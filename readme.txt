...
0.3.3 Fixed issue where multiple slideshows on the same page did not advance properly.

0.3.2 Javascript & typo fix
...
0.1: Use the included WordPress version of jQuery and properly load it with enqueue.